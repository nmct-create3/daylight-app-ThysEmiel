...
const placeSunAndStartMoving = (totalMinutes, sunrise) => {
	...
	const percentage = (100/totalMinutes) * minutesSunUp; // Verstreken perfectage v/d dag
	...
	// TO-DO We voegen ook de 'is-loaded' class toe aan de body-tag.
...
const getAPI = async (lat, lon) => {
	...
	let url = `http://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=7043b52944b90893596b33e2daf33553&units=metric&lang=nl&cnt=1`;
